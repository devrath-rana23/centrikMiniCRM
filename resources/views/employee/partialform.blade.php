<div>
    <input placeholder="{{ config('appplaceholder.FIRST_NAME') }}" type="text"
        value="{{ old('first_name', $company->first_name ?? null) }}" name="first_name"
...
<div>
    <input placeholder="{{ config('appplaceholder.LAST_NAME') }}" type="text"
        value="{{ old('last_name', $company->last_name ?? null) }}" name="last_name"
...
<div>
    <input placeholder="{{ config('appplaceholder.EMAIL') }}" type="text"
        value="{{ old('email', $company->email ?? null) }}" name="email"
...
<div>
    <input placeholder="{{ config('appplaceholder.PHONE') }}" type="number" maxlength="10" minlength="10"
        value="{{ old('phone', $company->phone ?? null) }}" name="phone"
...
<div>
    <input placeholder="{{ config('appplaceholder.PASSWORD') }}" type="password" maxlength="10" minlength="10"
        value="{{ old('password', $company->password ?? null) }}" name="password"
